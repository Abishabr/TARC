      ...
      <section className="pb-20 lg:pb-28">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-12 lg:gap-20">
            <div>
              <PlaceholderImage label="Director Photo" aspectRatio="square" className="w-full aspect-square" />
              <div className="mt-6">
                <p className="font-heading text-xl font-bold">{settings?.directorName || 'Director of TARC'}</p>
            ...
            <div>
              ...
              <div className="mt-8 pt-8 border-t border-border">
                <p className="font-heading text-lg font-bold">{settings?.directorName || 'Dr. [Director Name]'}</p>
                <p className="text-sm text-muted-foreground">{settings?.directorTitle || 'Director, TARC'}</p>
              </div>
            </div>
          </div>
        </div>
